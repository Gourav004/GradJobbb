      ...
      <div className="relative w-full min-h-screen bg-[#0a0a0a] text-white overflow-hidden font-['Inter',sans-serif] selection:bg-cyan-500/30">
        ...
        <div className="relative z-10">
          ...
          <nav className="flex justify-between items-center px-6 mt-6 sm:px-10 py-4">
            {/* Left - Logo */}
            <div
              className="text-2xl font-extrabold tracking-tight relative z-50"
          ...
          <AnimatePresence>
            {isMenuOpen && (
              <motion.div
                ...
                className="fixed inset-0 z-40 bg-[#0a0a0a]/95 backdrop-blur-xl flex flex-col items-center justify-center md:hidden"
              >
                <button
                  onClick={() => setIsMenuOpen(false)}
                  className="absolute top-10 right-6 text-zinc-400 hover:text-white p-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
